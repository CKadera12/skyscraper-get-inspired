...
(lib.ctarectanglerollovervideo = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(0.1,0,1.028,1.09);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.ctarectanglerollovervideo, new cjs.Rectangle(-67.5,-17.1,135.2,34.3), null);
...
p.nominalBounds = new cjs.Rectangle(-67.5,-17.1,135.2,34.3);
...
(lib.wideskyscrapergetinspired = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(103).call(this.frame_103).wait(77).call(this.frame_180).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(53).to({alpha:1},10).wait(123));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(65).to({alpha:1},10,cjs.Ease.get(1)).wait(111));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(75).to({alpha:1},10,cjs.Ease.get(1)).wait(101));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(85).to({alpha:1},10,cjs.Ease.get(1)).wait(91));
	...
	this.timeline.addTween(cjs.Tween.get(this.cta_rollover).wait(103).to({alpha:1},10).wait(73));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(103).to({alpha:1},10).wait(73));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(103).to({x:80,alpha:1},10).wait(73));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(9).to({alpha:1},10).wait(167));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(14).to({alpha:1},10).wait(162));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(24).to({alpha:1},10).wait(152));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(29).to({alpha:1},10).wait(147));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(35).to({alpha:1},10).wait(141));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_.png?1508190441431", id:"index_atlas_"}
	],
	preloads: []
};
